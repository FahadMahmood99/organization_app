...
ActiveRecord::Schema[8.1].define(version: 2026_06_29_171641) do
  ...
  create_table "member_projects", force: :cascade do |t|
    ...
    t.index ["member_id", "project_id"], name: "index_member_projects_on_member_id_and_project_id", unique: true
